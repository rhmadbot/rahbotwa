const  XBOT = 'ঔৣ͜͡R•ঔৣ͜͡M'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/rhmd_m'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6288245621406'; // Nomor whatsapplu cok
const aktif = 'Mulai dari jam 08:00 WIB'; // Kapan bot lu aktif
const groupwa = 'https://chat.whatsapp.com/CElCepKwWu699sbcyn9IIx'; // OFFICIAL GRUP LU 1
const youtube = 'Cooming Soon'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6288245621406:+62 882-4562-1406\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.sendMessage(id, 'Walaalaikumsallam' ,MessageType.text);
}
else if (text == 'salam'){
conn.sendMessage(id, 'Waalaikumsalam, Ketik #menu/#info/#donasi Contoh #menu' ,MessageType.text);
}
else if (text == 'asalamualaikum'){
conn.sendMessage(id, 'Waalaikumsallam' ,MessageType.text);
}
else if (text == 'Assalamualaikum'){
...
else if (text == 'Halojdj'){
conn.sendMessage(id, 'Ya?, Ketik #menu/#info/#donasi Contoh #menu' ,MessageType.text);
}
else if (text == 'Asujdjd'){
conn.sendMessage(id, 'Lu Asw' ,MessageType.text);
}
else if (text == '#owner'){
conn.sendMessage(id, 'Owner XBOT wa.me/+6288245621405' ,MessageType.text);
}
else if (text == 'hdjdjd'){
conn.sendMessage(id, 'Aku BOT nya XBOT' ,MessageType.text);
}
else if (text == 'maryana'){
conn.sendMessage(id, 'pacar Bot owner ihh' ,MessageType.text);
}
...
else if (text == 'Bachdhdot'){
conn.sendMessage(id, 'lu bacot_-' ,MessageType.text);
}
else if (text == 'Tesjdjt'){
...
else if (text == 'makajdjsi'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan :)' ,MessageType.text);
}
else if (text == 'Makajdsi'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan :)' ,MessageType.text);
}
else if (text == 'makasuduih'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan :)' ,MessageType.text);
}
else if (text == 'Makasijdjh'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan :)' ,MessageType.text);
}
else if (text == 'thanudk'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan :)' ,MessageType.text);
}
else if (text == 'Thanjdk'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan :)' ,MessageType.text);
}
else if (text == 'thankjds'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan :)' ,MessageType.text);
}
else if (text == 'Thanjdks'){
conn.sendMessage(id, 'Sama sama, semoga harimu menyenangkan :)' ,MessageType.text);
}
...
conn.sendMessage(id, ' Thanks Telah Menggunakan BOT *"ঔৣ͜͡R•ঔৣ͜͡M"* , Follow Instagram Mimin Yah : https://instagram.com/rhmd_m' ,MessageType.text);
}
else if (text == '#info'){
conn.sendMessage(id, ' Thanks Telah Menggunakan BOT *ঔৣ͜͡R•ঔৣ͜͡M* , Follow Instagram Mimin Yah� : https://instagram.com/rhmd_m' ,MessageType.text);
}
