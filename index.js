...
const config = {
    A187: '🔰_ঔৣ͜͡Rahmadঔৣ͜͡Bot_🔰', 
    nomer: 'wa.me/+1 (831) 353-5216', 
    whatsapp: 'https://chat.whatsapp.com/HJHbCZQHN3j3u3HOUfxB6y', 
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code is ready, scan gece ngentod`)
})
...
║*SEMOGA BETAH GAIS!* `
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["+62 882-4562-1406@s.whatsapp.net"] // ganti nomer lu
           ...
           case 'demote':
              ...
              case 'owner':
               ...
               client.sendMessage(from, '𝐍𝐢𝐞𝐡 𝐧𝐨𝐦𝐞𝐫 𝐎𝐰𝐧𝐞𝐫 𝐤𝐮 𝐤𝐚𝐤, 𝐣𝐢𝐤𝐚 𝐦𝐚𝐮 𝐦𝐚𝐬𝐮𝐤𝐚𝐧 aku 𝐤𝐞 𝐠𝐫𝐨𝐮𝐩 𝐤𝐚𝐥𝐢𝐚𝐧 𝐜𝐡𝐚𝐭 𝐝𝐢𝐚 𝐲𝐚𝐡 kak',MessageType.text, { quoted: mek} )
                break  
